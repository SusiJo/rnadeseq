...
```{r software_chunk, echo=T, message=T, eval=isProvided(params$path_software_versions)}
...
print("software_versions_csv: ", params$path_software_versions_csv)

print(paste0("Importing software versions from ", params$path_software_versions, " ..."))
if (software_versions_csv && !file.exists(params$path_software_versions)) {
    stop(paste0("The software versions file ", params$path_software_versions, " does not exist! Please check the path and try again."))
}
...
```{r software_versions_duplicate_chunk, echo=FALSE, message=FALSE, eval=isProvided(params$path_software_versions)}
# Import the .csv or .yml file output by the rna-seq Nextflow pipeline
software_versions_csv <- endsWith(params$path_software_versions, ".csv") || endsWith(params$path_software_versions, ".tsv")
if (software_versions_csv) {
    version_csv <- read.csv(file = params$path_software_versions, sep="\t", header = FALSE)
